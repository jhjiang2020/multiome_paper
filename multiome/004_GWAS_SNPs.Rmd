...
# load gwas catalog
gwas.hg38 <- format_GWAS_SNP("/well/ocallaghan/users/qhs307/raw_data/GWAS_catalog/gwasCatalog.txt.gz", p_value_threshold = 5e-8)
...
genotypeData = "/well/ocallaghan/users/qhs307/reference_genome/hg38_1000G/EUR/EUR_posid_hg38"
...
vcf = "/well/ocallaghan/users/qhs307/raw_data/dbSNP/dbSNP.common.hg38.vcf.gz"
...
bg <- readRDS("~/Oxford/Results/multiome/multiome_share/rdata/bgPeaks.rds")
```
...
oxLDL_induced.genes <- readRDS("~/Oxford/Results/multiome/multiome_share/rdata/MP.DE.genes.all_nov9.rds") %>% 
